...
for curr_layers in "${NUM_LAYERS[@]}"; do
    for curr_k in "${K[@]}"; do
        for curr_n in "${N[@]}"; do
            ...
            output_dir="output/checkpoints/exhaustion_testing/${combo}"

            # run training
            PYTHONPATH=. python train/v2/training_exhaust.py \
                --dataset1_path data/tokenized_datasets/lakh_baseline/b0d0dbce322fc3318387b6cc12cf096a/train.npy \
