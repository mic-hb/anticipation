#!/usr/bin/env python3
"""
GigaMIDI Subset S1: 10% Random from Everything (Batched Version)
...
def main():
    parser = argparse.ArgumentParser(
        description="Create S1: 10% random sample from ENTIRE GigaMIDI (BATCHED - FAST)"
    )
    parser.add_argument(
        "--output",
        type=str,
    ...
    print("=" * 70)
    print("GigaMIDI Subset S1 Creator - BATCHED (FAST VERSION)")
    print("=" * 70)
