...
This script creates S1 - a random 10% sample from the ENTIRE GigaMIDI train split.
No filtering applied - truly random sample from all files.

S1 Definition (from docs/amt-fine-tuning.md):
- Subset ID: S1
- Description: 10% random (stratified by instrument group)
- Files: ~105k
...
def main():
    parser = argparse.ArgumentParser(
        description="Create S1: 10% random sample from ENTIRE GigaMIDI train split"
    )
    parser.add_argument(
        "--output",
        type=str,
    ...
    print("=" * 70)
    print("GigaMIDI Subset S1 Creator - 10% Random from ENTIRE Dataset")
    print("=" * 70)
