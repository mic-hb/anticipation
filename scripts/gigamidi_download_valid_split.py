...
Usage:
    python scripts/gigamidi_download_valid_split.py \
        --output data/gigamidi_valid_raw/ \
        --limit 1000
...
def main():
    ...
    print("\n[Stage 1/3] Counting validation files...")
    ...
    print(f"  Total validation files: {total:,} in {count_time:.1f}s")
    sys.stdout.flush()
